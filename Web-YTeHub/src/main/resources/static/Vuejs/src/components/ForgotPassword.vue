...
<!-- Left Side: Visual Anchor (Exactly same as Login) -->
...
<p class="text-on-surface-variant font-medium">Nhập email của bạn để nhận hướng dẫn khôi phục mật khẩu.</p>
</div>
<!-- Form -->
<form class="space-y-8" onsubmit="return false;">
<div>
<label class="block font-label text-xs font-bold uppercase tracking-widest text-on-surface-variant mb-2" for="email">Địa chỉ Email</label>
<div class="relative">
